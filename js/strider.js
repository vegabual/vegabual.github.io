   ...
   google.maps.event.addDomListener(window, 'load', init);
         function init() {
                ...
                var mapOptions = {
                    ...
                    center: new google.maps.LatLng(-34.903153, -56.166850), // New York

                    // How you would like to style the map. 
                    // This is where you would paste any style found on Snazzy Maps.
                   styles: [{ "featureType": "all", "elementType": "all", "stylers": [{"invert_lightness": true},{"saturation": 10 }, { "lightness": 30 },
                       { "gamma": 0.5 }, {"hue": "#435158" } ]}] };
                ...
                var marker = new google.maps.Marker({
                    position: new google.maps.LatLng(-34.903153, -56.166850),
                    map: map,
                    icon: image,
                    title: 'Snazzy!'
                });
